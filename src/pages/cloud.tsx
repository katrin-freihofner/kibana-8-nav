...
import { CloudInPageNav } from '../components/cloud/chrome/nav';
      ...
      <EuiPageContent className="euiPageContent--restrictWidth">
        <EuiPageContentBody>
          <EuiFlexGroup>
              ...
              <EuiText grow={false}>
                ...
                <blockquote>
                  <p>
                    ...
                    those moments will be lost in time, like tears in rain. Time
                    to die.
                  </p>
                </blockquote>
                ...
                <p>
                  ...
                  mindfulness, so it had a greater sense of life-satisfaction
                  than that fox with all its silly jumping.
                </p>

                <p>
                  And from the fox&rsquo;s perspective, life was full of hoops
                  to jump <em>through</em>, low-hanging fruit to jump{' '}
            ...
            <EuiPageSideBar style={{ flexGrow: 0 }}>
              <CloudInPageNav />
            </EuiPageSideBar>
          </EuiFlexGroup>
        </EuiPageContentBody>
